...
// Replace template inputs
const searchTemplate = `                  <div v-if="notifType === 'telegram'" class="input-group mt-16">
...
const replaceTemplate = `                  <div v-if="notifType === 'telegram'" class="input-group mt-16">
...
code = code.replace(searchTemplate, replaceTemplate);
...
console.log('Updated OrderSettingsEditor.vue');
